...
public class MainMenuButton : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            button.transform.DOMoveX(-100f, 0.5f) //Se tudo funciona a partir da ancora, resta então se colocar o coiso proximo ao zero, ele vai ficar travado na posição da ancora. 
                .SetDelay(delay)
